 ...
 *
 * $Id: class.tx_rtehtmlarea_base.php,v 1.1.1.1 2010/04/15 10:03:59 peimic.comprock Exp $  *
 */
...
class tx_rtehtmlarea_base extends t3lib_rteapi {
	...
	function drawRTE(&$pObj,$table,$field,$row,$PA,$specConf,$thisConfig,$RTEtypeVal,$RTErelPath,$thePidValue)	{
		...
		<link rel="stylesheet" type="text/css" href="' . $this->editorCSS . '" />';
			...
			//Jaspreet Singh: if the RTE content is blank, set it to a blank paragrah.
			//This is to alleviate problems which cause initial text to appear larger
			//than it will be after the user presses Enter.
			if ((''==$value) || (!isset($value)) ) {$value = "<p>&nbsp;</p>";}
