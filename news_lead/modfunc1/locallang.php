...
$LOCAL_LANG = Array (
	"default" => Array (
		"title" => "Leads Download",	
		"description" => "This tool provides a means to download leads based
		...
		"submit_download" => "Download Leads",	
		"submit_display" => "Display Leads",	
		"reset" => "Clear Options",
		"user" => "User",	
		"summary" => "Count leads",	
		"nonsent" => "Include non-sent leads",	
		"noresults" => "No leads found on this page. Pleae choose a page or folder with leads.",	
	),
	"dk" => Array (
	),
	"de" => Array (
