...
/*
$Id: nusoap.php,v 1.1.1.1 2010/04/15 10:04:00 peimic.comprock Exp $
...
* @version  $Id: nusoap.php,v 1.1.1.1 2010/04/15 10:04:00 peimic.comprock Exp $
* @access   public
*/
class nusoap_base {
	/**
...
class wsdl extends nusoap_base {
	...
	*/
	...
	function serializeType($name, $type, $value, $use='encoded', $encodingStyle=false, $unqualified=false)
	{
        ...
        if (is_object($value) && get_class($value) == 'sobject'){
