...
CREATE TABLE tx_wecservant_minopp (
	...
	openings int(11) DEFAULT '' NOT NULL,
	reference_code tinytext NOT NULL,
	youth_friendly tinyint(4) unsigned DEFAULT '0' NOT NULL,
	supervision_required tinyint(4) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE fe_users (
	...
	tx_wecservant_shelbyid int(11) DEFAULT '' NOT NULL,
	tx_wecservant_bg_check_date tinytext
);

CREATE TABLE fe_groups (
	title varchar(48) DEFAULT '' NOT NULL,
	wecgroup_type int(11) DEFAULT '0' NOT NULL,
	tx_wecservant_ministryadministrator text,
);
...
#
# Table structure for table 'tx_wecservant_registrant'
#
CREATE TABLE tx_wecservant_registrant (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
	crdate int(11) DEFAULT '0' NOT NULL,
	tstamp int(11) DEFAULT '0' NOT NULL,
	minopp int(11) DEFAULT '0' NOT NULL,
	user_id int(11) DEFAULT '0' NOT NULL,
	message text NOT NULL,
	youth tinyint(4) DEFAULT '0' NOT NULL,
	parents_name tinytext NOT NULL,
	duplicate int(11) DEFAULT '0' NOT NULL,
	waitlist int(11) DEFAULT '0' NOT NULL,
