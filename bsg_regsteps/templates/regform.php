...
<?php } ?>    
	<tr>
		<td colspan="2">
			<h4>Conference Attendees - Make your event choice</h4>
			<p>If you have selected a Conference Package, please select your conference series.</p>
		</td>
	</tr>
	<tr>
		<td>Select One:</td>
		<td>
			<select id="conf_series" name="bsg_step_1[conf_series]">
<?php
$option							= '';
$confSeries						= $this->getVar('confSeries');
foreach ( $confSeries as $key => $value)
{
    $selected	= ( $value == $conf_series )
		? ' selected="selected" '
		: '';
