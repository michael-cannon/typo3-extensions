...
//			array('uid'=>'a0B50000001W1oV', 'name'=>'Simple, Open & Standardized BPM Metrics', 'type'=> 'training-per-1d'),
	...
	array(
		...
		'type'=>'conference',
		'courses' => array(
			array('uid'=>'DAY1', 'name'=>'1-Day Conference Package - September 22 Only', 'type'=> 'conference-1d'),
			array('uid'=>'2DAYS', 'name'=>'2-Day Conference Package - September 22-23', 'type'=> 'conference-2d'),
			array('uid'=>'2DAYSNS', 'name'=>'2-Day Non-Sponsoring Solution Provider Package - September 22-23', 'type'=> 'non-sponsoring'),
		),
	),
...
//			array('uid'=>'a0B50000001W1lv', 'name'=>'BPM and Six Sigma', 'type'=> 'training-per-1d'),
	...
	array(
		...
		'type'=>'conference',
		'courses' => array(
			array('uid'=>'DAY2', 'name'=>'1-Day Conference Package - September 23 Only', 'type'=> 'conference-1d'),
		),
	),
