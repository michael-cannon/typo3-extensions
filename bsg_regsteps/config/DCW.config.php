...
//			array('uid'=>'a0B50000001W1lv', 'name'=>'BPM and Six Sigma', 'type'=> 'training-per-1d'),
	...
	array(
		...
		'courses' => array(
			...
			array('uid'=>'a005000000FKtbe', 'name'=>'Sept 23 AM Only: Opening Keynote & Fujitsu Workshop', 'type'=> 'workshops'),
...
function checkCourseConfig( course ) {
	var doAlert = false;
	var errorMsg = "Select 1 training course OR 1 workshop PER DAY.";
