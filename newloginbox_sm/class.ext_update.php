...
<T3FlexForms>
	 ...
	 */
	function access()	{
		$res = @mysql(TYPO3_db, $this->query('count(*)'));
		if (mysql_error())		return false;	// In this case the old database fields has probably been removed and hence we don't need the update module for anything.
