 ...
 * 
 * TYPO3 CVS ID: $Id: locallang.php,v 1.1.1.1 2010/04/15 10:03:54 peimic.comprock Exp $
...
$LOCAL_LANG = Array (
	'default' => Array (
		...
		'oLabel_msg_error' => 'An error occurred during login. Most likely you didn\'t enter the username or password correctly.
Be certain that you enter them precisely as they are, including upper/lower case.
Another possibility is that cookies might be disabled in your webbrowser.',
		...
		'cookie_warning' => 'Warning: There is a possibility that cookies are not enabled in your webbrowser! If your login disappears on your next click that is the case and you should enable cookies (or accept cookies from this website) immediately!',
		'username' => 'Username:',
		'password' => 'Password:',
		'login' => 'Login',
		'logout' => 'Logout',
		...
		'forgot_password_pswmsg' => 'Your SavvyMiss Password
Hi %s
...
Savvy Miss
',
		'forgot_password_no_pswmsg' => 'Your password
Hi %s
...
',
		'forgot_password_enterEmail' => 'Please enter the email address by which you registered your user account. Then press "Send password" and your password will immediately be emailed to you. Make sure to spell your email address correctly.',
		'forgot_password_emailSent' => 'Your password has now been sent to the email address %s',
		'forgot_password_backToLogin' => 'Return to login form',
	),
	'dk' => Array (
...
Vi kunne ikke finde et brugernavn tilhørende denne email-adresse og kan derfor ikke sende et password til dig. Du har formentlig stavet din email adresse forkert (store og små bogstaver betragtes som forskellige) eller også har du ikke registreret dig selv endnu?',
	...
	'de' => Array (
		...
		'oLabel_msg_error' => 'Ein Fehler trat während der Anmeldung auf. Wahrscheinlich haben Sie Ihren Benutzernamen oder das Passwort falsch eingegeben.
Vergewissern Sie sich, dass Sie beide Angaben korrekt eingegeben haben - Groß-/Kleinschreibung wird unterschieden.
Eine andere Möglichkeit ist, dass Sie eventuell die Cookies in Ihrem Webbrowser deaktiviert haben.',
...
Wir konnten keine mit dem angegeben Benutzernamen verknüpfte Email-Adresse finden. Aus diesem Grund können wir Ihnen kein Passwort zusenden. Vielleicht haben Sie Ihre Email-Adresse fehlerhaft eingegeben (Groß-/Kleinschreibug wird unterschieden!) oder Sie haben sich eventuell noch garnicht registriert.',
	...
	'no' => Array (
		...
		'oLabel_msg_error' => 'Noe gikk galt under innloggingsprosedyren. Mest sannsynlig har du ikke tastet brukernavn og passord korrekt.
Forsikre deg om at du taster dem helt riktig inklusive store og små bokstaver.
En annen mulighet kan være at informasjonskapsler (cookies) er avslått i din nettleser.',
		...
		'cookie_warning' => 'Advarsel: Det er en sannsynlighet for at cookies ikke er slått på i din nettleser! Dersom ditt logg inn forsvinner ved neste klikk er det tilfellet og du bør slå på cookies (eller akseptere fra dette nettstedet) med det samme!',
		'username' => 'Brukernavn:',
		'password' => 'Passord:',
		'login' => 'Logg inn',
		'logout' => 'Logg ut',
...
Vi kunne ikke finne et brukernavn tilhørende denne e-post adressen og kan derfor ikke sende et passord til deg. Du har muligens stavet din e-post adresse feil (det skilles mellom store og små bokstaver) eller du har kanskje ikke registrert deg enda?',
	...
	'it' => Array (
		...
		'oLabel_msg_error' => 'Errore durante il login. Probabilmente non hai inserito correttamente lo username o la password.
...
Assicurati altresì di aver abilitato i cookies nel tuo browser.',
		...
		'oLabel_msg_success' => 'Hai effettuato il login come l\'utente \'###USER###\'',
		'oLabel_header_status' => 'Stato corrente',
		'oLabel_msg_status' => 'Questo è il tuo stato corrente:',
		'cookie_warning' => 'Attenzione: è probabile che il tuo browser non abbia i cookies abilitati! Se il messaggio di avvenuto login scompare nella prossima pagina che visiterai, allora devi abilitare (o accettare) i cookies provenienti da questo sito.',
		'username' => 'Username:',
		'password' => 'Password:',
		'login' => 'Login',
		'logout' => 'Logout',
...
Nel nostro sistema non c\'è alcun utente con l\'indirizzo email da te indicato. Probabilmente hai specificato un email non corretto (controlla la maiuscole/minuscole), oppure non ti sei mai registrato.',
		'forgot_password_enterEmail' => 'Inserisci l\'indirizzo email con il quale ti sei registrato. Stai attento a scriverlo correttamente! (anche per quanto riguarda le maiuscole/minuscole).  La tua password ti sarà immediatamente inviata!',
...
Votre mot de passe est "%s"',
	...
	'es' => Array (
		...
		'oLabel_msg_error' => 'Ha ocurrido un error durante el inicio de sesión. Lo mas normal es que haya introducido un nombre de usuario o contraseña incorrectos.
Asegúrese de que los introduce de manera exacta, respetando las mayúsculas y minúsculas.
Otra posibilidad es que tenga las cookies deshabilitadas en su navegador.',
...
No podemos encontrar un nombre de usuario para esta dirección de correo, por lo tanto no podemos enviarle ninguna contraseña. Probablemente se haya confundido al introducir su dirección de correo (compruebe las mayúsculas y minúsculas), o es probable que aún no esté registrado en el sistema.',
	...
	'nl' => Array (
		...
		'oLabel_msg_error' => 'Er is een fout opgetreden bij het inloggen. Waarschijnlijk heeft u uw gebruikersnaam of wachtwoord niet goed ingevoerd.
Zorg ervoor dat u die precies zo invoert als ze zijn, lettend op hoofdletters/kleine letters.
Ook kan het zijn dat cookies uitstaan in uw browser.',
...
We konden geen gebruikersnaam vinden met dit emailadres en kunnen u het wachtwoord niet toezenden. Waarschijnlijk heeft een een typefout gemaakt in het emailadres (hoofdletters / kleine letters maken verschil) of misschien bent u nog niet geregistreerd?',
	...
	'cz' => Array (
		'oLabel_header_welcome' => 'Pøihlášení uživatele',
		'oLabel_msg_welcome' => 'Pro pøihlášení vložte svoje pøihlašovací jméno a heslo:',
		'oLabel_header_logout' => 'Byli jste ohlášeni.',
		'oLabel_msg_logout' => 'Byli jste právì odhlášeni z uživatelské sekce tohoto webu. Nyní se mùžete pøihlásit jako jiný uživatel pomocí formuláøe dole.',
		'oLabel_header_error' => 'Chyba pøihlášení.',
		'oLabel_msg_error' => 'Pøi pøihlašování nastala chyba. Je možné, že jste nezadali správné pøihlašovací jméno a heslo.
Dejte prozor, aby jste tyto údaje zadali zcela pøesnì, vèetì správných velkých/malých znakù.
Je také nutné mít povoleny cookies ve vašem prohlížeci.',
		'oLabel_header_success' => 'Pøihlášení se podaøilo',
		'oLabel_msg_success' => 'Jste nyní pøihlášen/a jako \'###USER###\'',
		'oLabel_header_status' => 'Souèasný stav',
		'oLabel_msg_status' => 'Toto je váš souèasný stav',
		'cookie_warning' => 'Varování: je možné, že ve vašem prohlížeèi nejsou povoleny cookies - pokud vaše pøihlášení vyprší na další stránce, znamená to, že je musíte povolit.',
		...
		'forgot_password' => 'Zapomìli jste své heslo?',
		'forgot_password_pswmsg' => 'Vaše heslo
Dobrý den, pøihlašovací údaje pro %s jsou:

Jméno uživatele: "%s"
Heslo: "%s"',
		'forgot_password_no_pswmsg' => 'Vaše heslo
Dobrý den, 

uživatelské údaje pro %s  spojené s touto emailovou adresou nebyly nalezeny a proto Vám nové heslo nemohlo být zasláno.
Je možné, že jste zadali nesprávnì emailovou adresu (malá/velká písmena...) nebo nejste zatím zaregistrováni.',
		'forgot_password_enterEmail' => 'Prosím vyplòte emailovou adresu pod kterou jste registrováni a stisknìte tlaèítko "Odeslat heslo". Vaše heslo vám bude okamžitì zasláno. Dejte prosím pozor na pøesné zadání emailové adresy.',
		'forgot_password_emailSent' => 'Heslo bylo odesláno na email %s',
		'forgot_password_backToLogin' => 'Zpìt na pøihlašovací formuláø',
	),
	'pl' => Array (
		...
		'oLabel_msg_error' => 'Podczas logowania nast±pi³ b³±d. Najczê¶ciej jest on spowodowany z³ym loginem lub has³em.
Upewnij siê, ¿e poda³e¶ poprawnie dane, wielko¶æ liter.
Inny powód to wy³±czone ciasteczka (cookies) w twojej przegl±darce.',
		...
		'forgot_password_pswmsg' => 'Przypomnienie hasla 
Witaj %s

Twoj login to   %s
Twoje haslo to %s',
		'forgot_password_no_pswmsg' => 'Twoje haslo
Witaj %s

Nie moglismy znalezc u¿ytkownika o tym emailu. 
Byc moze zle podales adres email (wielkosc liter ma znaczenie) 
albo po prostu nie ma cie w naszej bazie.',
	...
	'fi' => Array (
		...
		'oLabel_msg_error' => 'Sisäänkirjoittautumisessa tapahtui virhe. Todennäköisesti et antanut käyttäjätunnusta tai salasanaa oikein.
Annoitko tiedot aivan oikein huomioiden isot ja pienet kirjaimet
Toinen mahdollisuus on ettei selaimessasi ole cookies käytössä.',
...
Emme löytäneet käyttäjätunnusta tälle sähköpostiosoitteelle emmekä siksi voi lähettää Sinulle salasanaa. Olet mahdollisesti antanut virheellisen sähköpostiosoiteen (huomaa isojen ja pienten kirjainten ero) tai ehkä et ole vielä rekisteröitynyt?',
	...
	'tr' => Array (
		'oLabel_header_welcome' => 'Oturum aç',
		'oLabel_msg_welcome' => 'Websitede oturum açabilmek için kullanýcý adý ve parolanýzý girin:',
		'oLabel_header_logout' => 'Oturumunuzu kapattýnýz.',
		'oLabel_msg_logout' => 'Kullanýcý oturumunuzu terk ettiniz. Alttaki formu kullanarak yeniden veya ayrý bir kullanýcý olarak oturum açabilirsiniz.',
		'oLabel_header_error' => 'Oturum açmada hata',
		'oLabel_msg_error' => 'Oturum açarken bir hata oluþtu. Muhtemelen kullanýcý adý veya parolanýzý hatalý girdiniz.
Bu bilgileri, büyük ve küçük karakterleri dikkate alarak, doðru girdiðinizden emin olun.
Cookie\'lerin internet tarayýcýnýz tarafýndan kabul edilmediði de muhtemel.
Eðer bu bilgilerin doðruluðundan eminseniz ve hala sorunla karþýlaþtýysanýz diðer bir hata sebebi cookie\'leriniz internet tarayýcýnýzda kapalý olabilir.',
		'oLabel_header_success' => 'Oturum baþarýyla açýldý',
		'oLabel_msg_success' => '###USER### olarak oturum açtýnýz.',
		'oLabel_header_status' => 'Güncel statü',
		'oLabel_msg_status' => 'Þu an ki statünüz:',
		'cookie_warning' => 'Uyarý: Cookie\'lerin internet tarayýcýnýzda kapalý olma ihtimali mevcut! Þayet oturumunuz bir sonraki týklamanýzla kayboluyorsa bu durumla karþýkarþýyasýnýz ve hemen cookie\'leri faal hale getirmeli veya bu websitenin cookie\'lerini kabul etmelisiniz!',
		'username' => 'Kullanýcý adý:',
		'password' => 'Parola:',
		'login' => 'Oturum aç',
		'logout' => 'Oturumu kapat',
		'send_password' => 'Parolayý gönder',
		'your_email' => 'E-postanýz:',
		'forgot_password' => 'Parolanýzý mý unuttunuz?',
		'forgot_password_pswmsg' => 'Parolanýz
Merhaba %s

Kullanýcý adýnýz \'%s\'
Parolanýz \'%s\'',
		'forgot_password_no_pswmsg' => 'Parolanýz
Merhaba %s

Bu e-posta adresine ayit kullanýcý adý bulamadýk ve bu yüzden parolayý size gönderemiyoruz.
Muhtemelen e-posta adresini hatalý girdiniz (büyük veya küçük karakterler fark eder) veya belki de üyeliðe baþvurmadýnýz.',
		'forgot_password_enterEmail' => 'Kullanýcý hesabýnýzý açarken berlirttiðiniz e-posta adresini girin. Ardýndan \'Parolayý gönder\'i týklayýn ve parolanýz anýnda e-posta kutunuza ulaþacaktýr. E-posta adresinizi doðru girdiðinizden emin olun.',
		'forgot_password_emailSent' => 'Parolanýz %s e-posta adresine gönderilmiþtir.',
		'forgot_password_backToLogin' => 'Oturum açma formuna geri dön',
	),
	'se' => Array (
		...
		'oLabel_msg_error' => 'Ett fel uppstod vid inloggningen. Mest troligt är, att du inte skrev in användarnamnet och lösenordet rätt.
Försäkra dej om att du skrev dem exact så som de är, med gemena och versaler.
En annan möjlighet är att du förbjudit din dator att ta emot Cookies.',
...
Vi kunde inte hitta ett användarnamn för detta lösenord så vi kan inte sända dej ditt lösenord. Det är möjligt att du skrivit din epostadress felaktigt (det är skillnad på små och stora bokstäver) eller så är du kanske inte ännu en registrerad användare?',
	...
	'pt' => Array (
		...
		'oLabel_msg_error' => 'Ocorreu um erro durante o Acesso. O mais comum é que você não digitou seu nome de utilizador/senha corretamente.
Esteja certo de que os digitou precisamente como são, incluindo maiúsculas/minúsculas.
Outra possibilidade é que seu navegador não aceita <i>cookies</i>.',
...
Não podemos encontrar um nome de utilizador para este endereço de e-mail e assim não podemos enviar-lhe a senha. Provavelmente você não digitou corretamente o endereço de e-mail (letras maiúsculas e minúsculas fazem diferença) ou talvez você não se tenha registado ainda?',
	...
	'ru' => Array (
		...
		'oLabel_msg_welcome' => 'Ââåäèòå èìÿ ïîëüçîâàòåëÿ è ïàðîëü äëÿ âõîäà â ñèñòåìó:',
		'oLabel_header_logout' => 'Âû âûøëè èç ñèñòåìû.',
		'oLabel_msg_logout' => 'Âû àâòîìàòè÷åñêè âîøëè â ñèñòåìó. ×òîáû çàðåãèñòðèðîâàòüñÿ ñíîâà èëè âîéòè â ñèñòåìó ïîä äðóãèì èìåíåì, èñïîëüçóéòå ôîðìó íèæå.',
		'oLabel_header_error' => 'Îøèáêà ïðè âõîäå â ñèñòåìó',
		'oLabel_msg_error' => 'Ïðîèçîøëà îøèáêà ïðè âõîäå â ñèñòåìó. Âåðîÿòíî èìÿ ïîëüçîâàòåëÿ èëè ïàðîëü íå ñîîòâåòñòâóþò.
Ïðîâåðüòå, ïðàâèëüíî ëè ââåäåíû äàííûå, áûë ëè èñïîëüçîâàí ïðàâèëüíûé ÿçûê, çàãëàâíûå èëè ïðîïèñíûå áóêâû.
Óáåäèòåñü òàêæå, äîïóñêàåò ëè Âàø îáîçðåâàòåëü Cookies.',
		'oLabel_header_success' => 'Âõîä â ñèñòåìó ïðîøåë óñïåøíî',
		'oLabel_msg_success' => 'Âàøå èìÿ ïîëüçîâàòåëÿ: \'###USER###\'',
		'oLabel_header_status' => 'Òåêóùèé ñòàòóñ',
		'oLabel_msg_status' => 'Âàø òåêóùèé ñòàòóñ:',
		'cookie_warning' => 'Âíèìàíèå: âîçìîæíî Âàø îáîçðåâàòåëü íå äîïóñêàåò Cookies! Åñëè ôîðìà âõîäà íå îòîáðàçèòñÿ ïîñëå ñëåäóþùåãî ùåë÷êà, óñòàíîâèòå äîïóñê Cookies!',
		'username' => 'Èìÿ ïîëüçîâàòåëÿ:',
		'password' => 'Ïàðîëü:',
		'login' => 'Âõîä â ñèñòåìó',
		'logout' => 'Âûõîä èç ñèñòåìû',
		'send_password' => 'Îòïðàâèòü',
		'your_email' => 'Âàø àäðåñ:',
		'forgot_password' => 'Çàáûëè ïàðîëü?',
		'forgot_password_pswmsg' => 'Âàø ïàðîëü

Çäðàâñòâóéòå, %s.

Âàøå èìÿ ïîëüçîâàòåëÿ: "%s"
Âàø ïàðîëü: "%s"',
		'forgot_password_no_pswmsg' => 'Âàø ïàðîëü

Çäðàâñòâóéòå, %s.

Ïîä óêàçàííûì Âàìè àäðåñîì ýëåêòðîííîé ïî÷òû íå áûë íàéäåí ïîëüçîâàòåëü ñèñòåìû.
Â ñâÿçè ñ ýòèì ìû íå ìîæåì îòïðàâèòü Âàì Âàø ïàðîëü.
Ïðîâåðüòå ïîæàëóéñòà, óêàçàëè ëè Âû ïðàâèëüíûé àäðåñ (ñèñòåìà ðàçëè÷àåò çàãëàâíûå è ïðîïèñíûå áóêâû).
Âîçìîæíî òàêæå, ÷òî Âû åùå íå ïðîøëè ðåãèñòðàöèþ.',
		'forgot_password_enterEmail' => 'Ââåäèòå, ïîæàëóéñòà, àäðåñ ýëåêòðîííîé ïî÷òû, óêàçàííûé Âàìè ïðè ðåãèñòðàöèè. Íàæìèòå íà "îòïðàâèòü", è Âû ïîëó÷èòå Âàø ïàðîëü íà äàííûé àäðåñ íåçàìåäëèòåëüíî. Óäîñòîâåðüòåñü â ïðàâèëüíîñòè óêàçàííîãî àäðåñà.',
		'forgot_password_emailSent' => 'Âàø ïàðîëü áûë âûñëàí ïî àäðåñó %s',
		'forgot_password_backToLogin' => 'Âåðíóòüñÿ ê ôîðìå âõîäà â ñèñòåìó',
	),
	'ro' => Array (
	),
	'ch' => Array (
	...
	'hr' => Array (
		'oLabel_header_welcome' => 'Korisnièka prijava',
		'oLabel_msg_welcome' => 'Unesite vaše korisnièko ime i lozinku kako bi se prijavili na website.',
		'oLabel_header_logout' => 'Odjavili ste se.',
		'oLabel_msg_logout' => 'Upravo ste se odjavili s ovih stranica. Možete se prijaviti ponovo ili kao drugi korisnik koristeæi sljedeæi formular.',
		'oLabel_header_error' => 'Prijava neuspješna',
		'oLabel_msg_error' => 'Greška se dogodila pri logiranju. Najvjerovatnije niste ispravno unijeli korisnièko ime ili lozinku.
Provjerite da budu uneseni toèno onako kako  su napisani, ukljuèujuæi velika i mala slova.
Druga je moguænost da su "cookies" onemoguæeni na vašem web pregledniku.',
		'oLabel_header_success' => 'Prijava uspješna',
		'oLabel_msg_success' => 'Prijavljeni se kao \'###USER###\'',
		'oLabel_header_status' => 'Trenutni status',
		'oLabel_msg_status' => 'Ovo je vaš trenutni status:',
		'cookie_warning' => 'Pažnja: Postoji moguænost da "cookies" nisu omoguæeni na vašem web pregledniku. Ako vaša prijava nestane pri sljedeæem kliku miša to je to i trebali bi omoguæiti "cookies" (accept cookies from this website).',
		...
		'forgot_password_pswmsg' => 'Vaša lozinka
Hi %s

Vaše korisnièko ime je  "%s"
Vaša lozinka je "%s"',
		'forgot_password_no_pswmsg' => 'Vaša lozinka
Hi %s

Nismo uspjeli pronaæi korisnièko ime za vašu e-mail adresu pa vam ne možemo poslati ni lozinku. Vjerovatno ste krivo ukucali e-mail adresu (velika/mala slova se razlikuju) ili se može niste još ni registrirali?',
		'forgot_password_enterEmail' => 'Molimo unesite e-mail adresu s kojom ste se registrirali. Potom pristisnite "Pošalji lozinku" i vaša æe vam lozinka biti odmah poslana. Pripazite da e-mail adresu unesete ispravno.',
		'forgot_password_emailSent' => 'Vaša je lozinka poslana na e-mail sdresu %s',
		'forgot_password_backToLogin' => 'Povratak na formular za prijavu',
	),
	'hu' => Array (
	),
	'gl' => Array (
		...
		'oLabel_msg_error' => 'Isernerata nalaani ajortoqarpoq. Ilimanarneruvoq atuisutut atit isissulluunniit allassimanngikkit.
Eqqoqqissaartumik allanneqartut qulakkeeruk, naqqinnerit angissusii puiornagulu.
Browserinni cookies atorunnaartinneqartut pisuutaasinnaapput aamma.',
...
e-mail adresse allannerlugunarpat (naqinnerit angissusii eqqamalaakkit) imaluuniit suli nalunaarsunngilatit?',
	...
	'br' => Array (
		'oLabel_header_welcome' => 'Identificação de Usuário',
		'oLabel_msg_welcome' => 'Informe aqui seu usuário e senha para identificar-se no site:',
		'oLabel_header_logout' => 'Você encerrou seu acesso ao site.',
		'oLabel_msg_logout' => 'Você acaba de se desconectar. Você pode entrar novamente ou como outro usuário através do formulário abaixo.',
		'oLabel_header_error' => 'Falha no Acesso.',
		'oLabel_msg_error' => 'Ocorreu um erro durante o acesso. O mais provável é que você não digitou seu usuário/senha corretamente.
Certifique-se de que digitou corretamente, incluindo maiúsculas/minúsculas.
Outra possibilidade é que seu navegador não aceita <i>cookies</i>.',
		'oLabel_header_success' => 'Acesso bem sucedido.',
		'oLabel_msg_success' => 'Você está agora conectado como \'###USER###\'',
		'oLabel_header_status' => 'Situação atual',
		'oLabel_msg_status' => 'Esta é sua situação atual:',
		'cookie_warning' => 'Atenção: Há a possibilidade dos cookies não estarem ativos em seu navegador. Se o seu login desaparecer no seu próximo clique é por que é necessário habilitar os cookies (ou aceitar cookies deste website) imediatamente!',
		'username' => 'Usuário:',
		'password' => 'Senha:',
		'login' => 'Acesso',
		'logout' => 'Sair',
...
Não podemos encontrar um usuário para este endereço de e-mail e assim não podemos enviar-lhe a senha. Provavelmente você não digitou corretamente o endereço de e-mail (letras maiúsculas e minúsculas fazem diferença) ou talvez você não se tenha registado ainda?',
		'forgot_password_enterEmail' => 'Por favor, digite o endereço de e-mail que você usou ao registar seu usuário. Então pressione "Enviar senha" e sua senha será imediatamente enviada por e-mail. Certifique-se que seu endereço de e-mail esteja correto.',
		'forgot_password_emailSent' => 'Sua senha foi agora enviada para o e-mail %s',
		'forgot_password_backToLogin' => 'Retornar ao formulário de acesso',
	),
	'et' => Array (
