<?php
/**
 * JPagination replacement for TYPO3
 *
 * @ref http://apostilas.fok.com.br/docs/joomla-1.5/nav.php?libraries/joomla/html/pagination.php.php
 *
 * @author Michael Cannon <michael@peimic.com>
 * @version $Id: class.JPagination.php,v 1.1.1.1 2010/04/15 10:03:39 peimic.comprock Exp $
 */
/**
 * @version		$Id: class.JPagination.php,v 1.1.1.1 2010/04/15 10:03:39 peimic.comprock Exp $
 ...
 * @since		1.5
 */
class JPagination extends tslib_pibase {
	/**
	...
	function get( $var ) {
		return ( isset($this->_internal[$var]) )
			? $this->_internal[$var])
			: null;
	}

	function set( $var, $value ) {
		$this->_internal[$var] = $value;
	}
