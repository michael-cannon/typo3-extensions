<?php
/* @version $Id: sugarError.php,v 1.1.1.1 2010/04/15 10:03:40 peimic.comprock Exp $ */
     ...
     */
        ...
        if($sugar) {
            if($sugar['number'] != '0') {
                ...
                $this->sugarErrorNumber = $sugar['number'];
                $this->sugarErrorName = $sugar['name'];
                $this->sugarErrorText = $sugar['description'];
            }
        }
    }
