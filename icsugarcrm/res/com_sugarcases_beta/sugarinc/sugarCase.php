<?php
/* @version $Id: sugarCase.php,v 1.1.1.1 2010/04/15 10:03:39 peimic.comprock Exp $ */
...
class sugarCase extends sugarCommunication {
	var $module = "Cases";

    function sugarCase(&$confObj, $pusername=false) {
...
/** [IC] 2006/05/22 - pagination */
    function getSome($fieldstosearch = array(), $orderby = array('case_number'=>'desc'), $fieldstoReturn = array(),$row_offset='', $limit='' ) {
        $this->createAutosession();

        $orderby = $this->_getOrderBy($orderby);
        $result = $this->_getEntryList($fieldstosearch, $orderby, $fieldstoReturn, $row_offset, $limit);
    ...
    function createNew($case) {
        $case['status'] = "New"; //TODO: set default elsewhere
