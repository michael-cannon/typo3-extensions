...
class Validate_Credit_Card
{
  ...
  */
  var $error_text = array (
                           ...
                           ,ERR_BAD_TYPE_MATCH => "Please check your credit card type."
                          );
  ...
  */
  ...
  /**
   * Simple credti card text to constant handler
   *
   * @var array
   * @access public
   */
  var $cc_text_type				= array (
  									'amex'		=> CC_AMERICAN_EXPRESS
									, 'visa'	=> CC_VISA
									, 'mc'		=> CC_MASTER_CARD
									, 'disc'	=> CC_DISCOVER
									, 'diners'	=> CC_DINERS_CLUB
									, 'jb'		=> CC_JB
								);
