...
// |                                                                      |
// +----------------------------------------------------------------------+
// | http://tx_chcforum_tpower.codocad.com                                     |
// +----------------------------------------------------------------------+
//
// $Id: class.tx_chcforum_tpower.php,v 1.1.1.1 2010/04/15 10:03:17 peimic.comprock Exp $

// note -- modified version for typo3
...
class tx_chcforum_tpparser
{
  ...
  var $version;
   ...
   /**
    * tx_chcforum_tpparser::tx_chcforum_tpparser()
    * 
    * @param $tpl_file
    * @param $type
    * @return 
	...
	* @access private
    */
   function tx_chcforum_tpparser( $tpl_file, $type )
   {
       $this->version        = '3.0.2';
   ...
   /**
    * tx_chcforum_tpparser::__errorAlert()
    * 
    * @param $message
    * @return 
	* 
   ...
   /**
    * tx_chcforum_tpparser::__prepare()
    * 
    * @return 
	* 
	* @access private
   ...
   function __prepare()
   {
    ...
    /**
     * tx_chcforum_tpparser::__cleanUp()
     * 
     * @return 
	 * 
	 * @access private
    ...
    /**
     * tx_chcforum_tpparser::__prepareTemplate()
     * 
     * @param $tpl_file
     * @param $type
     * @return 
    ...
    function __prepareTemplate( $tpl_file, $type )
    {
        ...
        else
        {
            $this->{$tplvar}["content"] = @file( $tpl_file ) or
                die( $this->__errorAlert('tx_chcforum_tpower Error: Couldn\'t open [ '. $tpl_file .' ]!'));
        }
    ...
    /**
     * tx_chcforum_tpparser::__parseTemplate()
     * 
     * @param $tplvar
     * @param $blockname
     * @param $initdev
                           ...
                           //check if the includescript file is assigned by the assignInclude function
                            ...
                            if( $include_defined )
                            {
                                ob_start();
                                    ...
                                    {
                                        $this->__errorAlert( 'tx_chcforum_tpower Error: Couldn\'t include script [ '. $include_file .' ]!' );
										                    exit();
                                    }
								                }
								                else
                           ...
                           //do match for 'AS'
                            if (preg_match('/(.+) AS (.+)/', $regs[2], $reuse_regs))
                            {
                               ...
                               //test if original block exist
                                ...
                                {
                                    $this->__errorAlert('tx_chcforum_tpower Error: Can\'t find block \''. $originalbname .'\' to REUSE as \''. $copybname .'\'');
                                }
                            }
                            else
                            {
    ...
    /**
     * tx_chcforum_tpparser::assignInclude()
     * 
     * @param $iblockname
     * @param $value
     * @param $type
...
class tx_chcforum_tpower extends tx_chcforum_tpparser

{
  ...
  var $prepared;
    ...
    /**
     * tx_chcforum_tpower::tx_chcforum_tpower()
     * 
     * @param $tpl_file
     * @param $type
     * @return 
	 ...
	 * @access public
     */
    function tx_chcforum_tpower( $tpl_file='', $type= T_BYFILE )
    {
        tx_chcforum_tpparser::tx_chcforum_tpparser( $tpl_file, $type );
    ...
    /**
     * tx_chcforum_tpower::__deSerializeTPL()
     * 
     * @param $stpl_file
     * @param $tplvar
     * @return 
    ...
    function __deSerializeTPL( $stpl_file, $type )
    {
        if( $type == T_BYFILE )
        {
            $serializedTPL = @file( $stpl_file ) or
                die( $this->__errorAlert('tx_chcforum_tpower Error: Can\'t open [ '. $stpl_file .' ]!'));
        }
        else
        {
    ...
    /**
     * tx_chcforum_tpower::__makeContentRoot()
     * 
     * @return 
	 * 
	 * @access private
    ...
    /**
     * tx_chcforum_tpower::__assignGlobal()
     * 
     * @param $varname
     * @param $value
     * @return 
    ...
    /**
     * tx_chcforum_tpower::__outputContent()
     * 
     * @param $blockname
     * @return 
	 * 
  ...
  ***********/
    ...
    /**
     * tx_chcforum_tpower::serializedBase()
     * 
     * @return 
	 * 
	 * @access public
    ...
    /**
     * tx_chcforum_tpower::showUnAssigned()
     * 
     * @param $state
     * @return 
	 * 
    ...
    /**
     * tx_chcforum_tpower::assignGlobal()
     * 
     * @param $varname
     * @param $value
     * @return 
    ...
    /**
     * tx_chcforum_tpower::getVarValue()
     * 
     * @param $varname
     * @return 
	 * 
    ...
    /**
     * tx_chcforum_tpower::printToScreen()
     * 
     * @return 
	 * 
	 * @access public
    ...
    function printToScreen()
    {
        ...
        {
            $this->__errorAlert('tx_chcforum_tpower Error: Template isn\'t prepared!');
        }
    }

    /**
     * tx_chcforum_tpower::getOutputContent()
     * 
     * @return 
	 * 
	 * @access public
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/chc_forum/pi1/class.tx_chcforum_tpower.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/chc_forum/pi1/class.tx_chcforum_tpower.php']);
}
