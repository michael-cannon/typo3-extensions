	...
	'columns' => Array (
		...
		'category' => Array (
			...
			'config' => Array (
				...
				'foreign_table_where' => $fTableWhere.'ORDER BY tt_news_cat.title',
				// MLC was 3
				'size' => 10,
				'autoSizeMax' => 10,
				'minitems' => 0,
...
/*		'hidden' => Array (
		...
		*/
		...
		'canned_template' => Array (
            'exclude' => 1,
            'l10n_mode' => 'exclude',
			'label' => 'LLL:EXT:tt_news/locallang_tca.php:tt_news_cat.canned_template',
            'config' => Array (
                'type' => 'group',
                'internal_type' => 'file',
                'allowed' => 'tmpl,html,htm',    // Must be empty for disallowed to work.
                'disallowed' => 'php,php3',
                'max_size' => 100,
		...
		'rounded_template' => Array (
            'exclude' => 1,
            'l10n_mode' => 'exclude',
			'label' => 'LLL:EXT:tt_news/locallang_tca.php:tt_news_cat.rounded_template',
            'config' => Array (
                'type' => 'group',
                'internal_type' => 'file',
                'allowed' => 'tmpl,html,htm',    // Must be empty for disallowed to work.
	...
	'types' => Array (
		'0' => Array('showitem' => 'title,title_lang_ol,rounded_template,canned_template,image;;1;;1-1-1,single_pid'),
