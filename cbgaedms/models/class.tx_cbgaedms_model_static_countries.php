...
/**
 * Class that implements the model for table tx_cbgaedms_static_countries.
 *
...
class tx_cbgaedms_model_static_countries extends tx_cbgaedms_model_common {

	function tx_cbgaedms_model_static_countries($controller = null, $parameter = null) {
	...
	function load($parameters = null) {
			...
			// fix settings
			$fields = '*';
			$tables = 'tx_cbgaedms_static_countries';
			$groupBy = null;
			$orderBy = null;
	...
	function loadCountriesAsOptions($parameters = null) {
		$fields = 'uid optionvalue
			, cn_short_en optionname
		';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cbgaedms/models/class.tx_cbgaedms_model_static_countries.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cbgaedms/models/class.tx_cbgaedms_model_static_countries.php']);
}
